---
title: "Career Performance Prediction App"
author: "Greeshmanth Srireddy-Sai Dhanya Kakarala-Praful Chand Potluri"
date: "2024-04-12"
output:
...
#Purpose
#The purpose of the "Career Advancement Predictor" project is to develop a predictive model that can forecast the likelihood of career advancement for professionals based on their years of experience and skill sets. This tool aims to assist individuals in understanding their career progression potential, enabling them to make informed decisions about career development and skill enhancement.
...
#Objectives
#The primary objectives of the "Career Advancement Predictor" project are:
...
#The string "/Users/greeshmanthsrireddy/Desktop/R-Project/linkedin.csv" specifies the location of a file on the file system. This string is a path that points to where the file linkedin.csv is stored:
#/Users/greeshmanthsrireddy/: The home directory for the user "greeshmanthsrireddy".
...
```{r}
linkedin_data <- read.csv("/Users/greeshmanthsrireddy/Desktop/R-Project/linkedin.csv")
head(linkedin_data)
```
...
#Title: "Career Advancement Predictor" is set as the title of the navigation bar.
...
#Here is a narrative description of the Shiny application titled "Career Advancement Predictor." This narrative explains the purpose, functionality, and structure of the application, offering insights into how users can interact with it and what they can expect in terms of features and outputs.

#Overview
#The "Career Advancement Predictor" is a dynamic web application built using R's Shiny framework, designed to help professionals assess their potential for career advancement based on specific career metrics. The app leverages a Random Forest machine learning model to predict the likelihood of career advancement by considering factors such as years of experience and skill count.
...
https://github.com/Greeshmanth-Srireddy/Career-Prediction-Performance.git
